...
part 'archive_accounts_state_notifier.freezed.dart';

final archiveAccountsStateNotifier =
    StateNotifierProvider.autoDispose<
        ArchiveAccountsStateNotifier,
        ArchiveAccountsState
    >((ref) {
      return ArchiveAccountsStateNotifier(ref.read(accountServiceProvider));
    });

class ArchiveAccountsStateNotifier extends StateNotifier<ArchiveAccountsState> {
  final AccountService _accountService;

  ArchiveAccountsStateNotifier(this._accountService)
    : super(ArchiveAccountsState(searchController: TextEditingController())) {
    getAccounts();
  }
  ...
  Future<void> getAccounts() async {
    try {
      ...
      final accounts = await _accountService.fetchArchivedAccounts();
...
@freezed
abstract class ArchiveAccountsState with _$ArchiveAccountsState {
  const factory ArchiveAccountsState({
