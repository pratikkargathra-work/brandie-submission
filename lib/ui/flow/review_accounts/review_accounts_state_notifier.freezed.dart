...
part of 'review_accounts_state_notifier.dart';
...
@override
String toString() {
  return 'ReviewAccountsState(loading: $loading, accounts: $accounts, sortedAccounts: $sortedAccounts, orderBy: $orderBy, orderSortFormat: $orderSortFormat, searchController: $searchController, filterEnable: $filterEnable, error: $error)';
}
...
/// @nodoc
abstract mixin class $ReviewAccountsStateCopyWith<$Res>  {
  factory $ReviewAccountsStateCopyWith(ReviewAccountsState value, $Res Function(ReviewAccountsState) _then) = _$ReviewAccountsStateCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ReviewAccountsStateCopyWithImpl<$Res>
    implements $ReviewAccountsStateCopyWith<$Res> {
  _$ReviewAccountsStateCopyWithImpl(this._self, this._then);

  final ReviewAccountsState _self;
  final $Res Function(ReviewAccountsState) _then;
...
/// @nodoc
abstract mixin class _$ReviewAccountsStateCopyWith<$Res> implements $ReviewAccountsStateCopyWith<$Res> {
